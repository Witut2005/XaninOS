...
def compile_kernel(*kargs):
    ...
    commands = [
        ...
        f'python3 ./build/app_preinstall2.py --files external_apps/ etc/ images/ --image xanin.img {"--dont_print_xin_info" if args.dont_print_xin_info == True else ""}',
...
objects_to_compile = {
    ...
    'libc':[
        ...
        CompileObject('./lib/libc/stdlibx/flow/flow.c', builders['c'], builder_options['c']['lib'], OBJECT),
        CompileObject('./lib/libc/interval.c', builders['c'], builder_options['c']['lib'], OBJECT),

        CompileObject('./lib/libc/data_structures/stack/stack.c', builders['c'], builder_options['c']['lib'], OBJECT),
    ...
    'built-in programs': [
        ...
        CompileObject('./programs/tests/c/sprintf_test.cpp', builders['cc'], builder_options['cc']['default'], OBJECT),
