...
public:
    ForwardArrayIterator(iterable_type i_ptr, Arr& arr) : ForwardIterator<Arr>(i_ptr, arr)
    {
        this->begin = arr.ptr;
        this->end = arr.ptr + arr.size();
    }

    ForwardArrayIterator(const ForwardArrayIterator<Arr>& other) = default;
...
public:
    ConstForwardArrayIterator(iterable_type i_ptr, Arr& arr) : ConstForwardIterator<Arr>(i_ptr, arr)
    {
        this->begin = arr.ptr;
        this->end = arr.ptr + arr.size();
    }

    ConstForwardArrayIterator(const ConstForwardArrayIterator<Arr>& other) = default;
...
public:
    ReversedArrayIterator(iterable_type i_ptr, Arr& arr) : ReversedIterator<Arr>(i_ptr, arr)
    {
        this->rbegin = arr.ptr + arr.size() - 1;
        this->rend = arr.ptr - 1;
    }

    ReversedArrayIterator(const ReversedArrayIterator<Arr>& other) = default;
...
public:
    ConstReversedArrayIterator(iterable_type i_ptr, Arr& arr) : ConstReversedIterator<Arr>(i_ptr, arr)
    {
        this->rbegin = arr.ptr + arr.size() - 1;
        this->rend = arr.ptr - 1;
    }

    ConstReversedArrayIterator(const this_type& other) = default;
