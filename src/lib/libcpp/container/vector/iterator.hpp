...
public:
    ForwardVectorIterator() : ForwardIterator<Vec>() {}

    ForwardVectorIterator(iterable_type i_ptr, Vec& vec) : ForwardIterator<Vec>(i_ptr, vec)
    {
    }

    ForwardVectorIterator(const this_type& other) = default;
...
public:
    ConstForwardVectorIterator(iterable_type i_ptr, Vec& vec) : ConstForwardIterator<Vec>(i_ptr, vec) {}
    ConstForwardVectorIterator(const this_type& other) = default;
...
public:
    ReversedVectorIterator(iterable_type i_ptr, Vec& vec) : ReversedIterator<Vec>(i_ptr, vec) {}

    ReversedVectorIterator(const this_type& other) = default;
...
public:
    ConstReversedVectorIterator(iterable_type i_ptr, Vec& vec) : ConstReversedIterator<Vec>(i_ptr, vec) {}

    ConstReversedVectorIterator(const this_type& other) = default;
