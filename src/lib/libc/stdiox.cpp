...
#define XSCANF_STRING_TYPED_BUFFER_SIZE XANIN_PMMNGR_BLOCK_SIZE * 2 * 5
    ...
    //     while (1)
    //     {
    //         xchar input = __sys_inputg();

    //         if (input.scan_code == KBP_BACKSPACE)
    //         {
    //             if (index)
    //             {
    //                 index--;
    ...
    //         else if (input.scan_code == KBSP_ARROW_UP)
    //         {
    //             __sys_xtb_scroll_up(vty);
    //         }

    //         else if (input.scan_code == KBSP_ARROW_DOWN)
    //         {
    //             __sys_xtb_scroll_down(vty);
    //         }

    //         else if (input.scan_code == KBSP_ARROW_LEFT)
    //         {
    //             __sys_xtf_cursor_dec(vty);
    //         }

    //         else if (input.scan_code == KBSP_ARROW_RIGHT)
    //         {
    //             __sys_xtf_cursor_inc(vty);
    //         }
