...
#define VGA_CRTC_LOCK()                                                                         \
    outbIO(VGA_CRTC_INDEX_REGISTER, VGA_CRTC_VERTICAL_RETRACE_END_INDEX); /* Wybierz 0x11 */        \
    outbIO(VGA_CRTC_DATA_REGISTER, inbIO(VGA_CRTC_DATA_REGISTER) | 0x80) /* Ustaw bit 7 */

#define VGA_CRTC_UNLOCK()                  \
	outbIO(VGA_CRTC_INDEX_REGISTER, 0x11); \
	outbIO(VGA_CRTC_DATA_REGISTER, inbIO(VGA_CRTC_DATA_REGISTER) & (~0x80))

// Paleta VGA 256-kolorowa (768 bajtów)
// uint8_t palette_256_colors[768] = {R0, G0, B0, R1, G1, B1, ..., R255, G255, B255}
const uint8_t vga_grayscale_palette_256[768] = {
    //
    // INDEKSY 000 - 063: Pierwsza pełna skala szarości (0-63)
    //
    ...
    //
    // INDEKSY 064 - 127: Powtórzenie skali (dla uproszczenia kodu)
    //
    0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02, 0x03, 0x03, 0x03, 
    0x04, 0x04, 0x04, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x07, 0x07, 0x07, 
    0x08, 0x08, 0x08, 0x09, 0x09, 0x09, 0x0A, 0x0A, 0x0A, 0x0B, 0x0B, 0x0B, 
    ...
    //
    // INDEKSY 128 - 191: Powtórzenie skali
    //
    0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02, 0x03, 0x03, 0x03, 
    0x04, 0x04, 0x04, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x07, 0x07, 0x07, 
    0x08, 0x08, 0x08, 0x09, 0x09, 0x09, 0x0A, 0x0A, 0x0A, 0x0B, 0x0B, 0x0B, 
    ...
    //
    // INDEKSY 192 - 255: Powtórzenie skali
    //
    0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x02, 0x03, 0x03, 0x03, 
    0x04, 0x04, 0x04, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x07, 0x07, 0x07, 
    0x08, 0x08, 0x08, 0x09, 0x09, 0x09, 0x0A, 0x0A, 0x0A, 0x0B, 0x0B, 0x0B, 
...
const uint8_t vga_std_palette_256[768] = {
    ...
    0x00, 0x00, 0x2A,  /* 01 - Ciemnoniebieski */
    0x00, 0x2A, 0x00,  /* 02 - Ciemnozielony */
    0x00, 0x2A, 0x2A,  /* 03 - Ciemny cyjan */
    0x2A, 0x00, 0x00,  /* 04 - Ciemnoczerwony */
    0x2A, 0x00, 0x2A,  /* 05 - Ciemny magenta */
    0x2A, 0x15, 0x00,  /* 06 - Ciemny brąz */
    0x2A, 0x2A, 0x2A,  /* 07 - Jasnoszary */
    0x15, 0x15, 0x15,  /* 08 - Ciemnoszary */
    0x15, 0x15, 0x3F,  /* 09 - Jasnoniebieski */
    0x15, 0x3F, 0x15,  /* 10 - Jasnozielony */
    0x15, 0x3F, 0x3F,  /* 11 - Jasny cyjan */
    0x3F, 0x15, 0x15,  /* 12 - Jasnoczerwony */
    0x3F, 0x15, 0x3F,  /* 13 - Jasny magenta */
    0x3F, 0x3F, 0x15,  /* 14 - Żółty */
    0x3F, 0x3F, 0x3F,  /* 15 - Biały */

    /* 016-215: Kolory podstawowe 6x6x6 (gradienty dla R, G, B) */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x0B, 0x00, 0x00, 0x16, 0x00, 0x00, 0x21, 0x00, 0x00, 0x2C, 0x00, 0x00, 0x37,
    0x00, 0x0B, 0x00, 0x00, 0x0B, 0x0B, 0x00, 0x0B, 0x16, 0x00, 0x0B, 0x21, 0x00, 0x0B, 0x2C, 0x00, 0x0B, 0x37,
    0x00, 0x16, 0x00, 0x00, 0x16, 0x0B, 0x00, 0x16, 0x16, 0x00, 0x16, 0x21, 0x00, 0x16, 0x2C, 0x00, 0x16, 0x37,
    0x00, 0x21, 0x00, 0x00, 0x21, 0x0B, 0x00, 0x21, 0x16, 0x00, 0x21, 0x21, 0x00, 0x21, 0x2C, 0x00, 0x21, 0x37,
    0x00, 0x2C, 0x00, 0x00, 0x2C, 0x0B, 0x00, 0x2C, 0x16, 0x00, 0x2C, 0x21, 0x00, 0x2C, 0x2C, 0x00, 0x2C, 0x37,
    0x00, 0x37, 0x00, 0x00, 0x37, 0x0B, 0x00, 0x37, 0x16, 0x00, 0x37, 0x21, 0x00, 0x37, 0x2C, 0x00, 0x37, 0x37,
    // [Reszta 6x6x6] ... 200 kolorów

    /* ... (Tutaj brakuje środkowej części dla 6x6x6 - aby zaoszczędzić miejsce. W pełnej palecie to powinno być 200 kolorów) ... */
    
    0x37, 0x37, 0x00, 0x37, 0x37, 0x0B, 0x37, 0x37, 0x16, 0x37, 0x37, 0x21, 0x37, 0x37, 0x2C, 0x37, 0x37, 0x37,
    
    /* 216-231: Skala szarości */
    0x03, 0x03, 0x03,
    0x06, 0x06, 0x06,
    0x09, 0x09, 0x09,
    0x0C, 0x0C, 0x0C,
    ...
    /* 232-255: Rezerwa (możesz użyć ich dla dedykowanych kolorów tła, interfejsu itp.) */
    // Wypełniam resztę losowymi, jasnymi kolorami
    0x3F, 0x00, 0x00, 0x00, 0x3F, 0x00, 0x00, 0x00, 0x3F, // Czerwony, Zielony, Niebieski
    0x3F, 0x3F, 0x00, 0x3F, 0x00, 0x3F, 0x00, 0x3F, 0x3F, // Żółty, Magenta, Cyjan
    // Reszta wypełniona czernią (lub dowolnie)
    // W rzeczywistości powinna być tu kontynuacja skali szarości i kilka rezerwowych kolorów.
    // Zostawiam tu miejsce do Twojej własnej definicji, np.
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // ...

    // ... (pozostałe bajty wypełnione 0x00)
    // Musisz upewnić się, że tablica ma dokładnie 768 bajtów!
};
...
unsigned char g_320x200x256[] =
{
    ...
    0x63,
    /* SEQ */
    0x03, 0x01, 0x0F, 0x00, 0x0E, // Powrót do oryginalnego 0x0E
    /* CRTC */
    0x5F, 0x4F, 0x50, 0x82, 0x54, 0x80, 0xBF, 0x1F,
    0x00, 0x41, 0x00, 0x00, 0x00, 0xA0, 0x00, 0x00, // Poprawione 0xA0 dla Offsetu
...
void vga_load_palette(VGA_COLOR_PALETTE palette) {
	switch (palette)
	{
	case VGA_PALETTE_GRAYSCALE:
		vga_load_custom_palette(vga_grayscale_palette_256);
		break;
	
	default:
		vga_load_custom_palette(vga_std_palette_256);
		break;
	}
}
...
void vga_load_custom_palette(const uint8_t *palette_data)
{
    ...
    outbIO(VGA_DAC_WRITE_INDEX, 0x00);

    // Krok 2: Zapisz wszystkie 256 kolorów
    for (int i = 0; i < 256 * 3; i++)
    {
        // Dane są zapisywane kolejno: R0, G0, B0, R1, G1, B1, ...
        // Po każdym zapisie bajtu, DAC automatycznie przechodzi do następnej składowej
...
void vga_mode_set(xgm_t mode)
{
	...
	case VGA_GRAPHICS_320x200x4:
	{
		vga_registers_write(g_320x200x4);
		break;
	}

	case VGA_GRAPHICS_640x480x16:
	{
		vga_registers_write(g_640x480x16);
		break;
	}
	...
	case VGA_GRAPHICS_320x200x256:
	{
		...
		vga_load_palette(VGA_PALETTE_DEFAULT);
		break;
	}

	case VGA_GRAPHICS_320x200x256_MODEX:
	{
		vga_registers_write(g_320x200x256_modex);
		break;
	}
	}
...
void vga_load_bmp_palette(const uint8_t *bmp_palette, int num_colors) 
{
	...
	{
        // Bajty w BMP: B, G, R, X (zero padding)
        uint8_t B_bmp = bmp_palette[i * 4 + 0];
        uint8_t G_bmp = bmp_palette[i * 4 + 1];
        uint8_t R_bmp = bmp_palette[i * 4 + 2];

        // Konwersja 8-bitowej składowej BMP (0-255) do 6-bitowej VGA (0-63)
        uint8_t R_vga = R_bmp >> 2; // Dzielenie przez 4, aby zmieścić w 6 bitach
        uint8_t G_vga = G_bmp >> 2;
        uint8_t B_vga = B_bmp >> 2;

        // Zapis do rejestrów DAC VGA
        outbIO(VGA_DAC_WRITE_INDEX, i); 
        outbIO(VGA_DAC_DATA, R_vga);
        outbIO(VGA_DAC_DATA, G_vga);
        outbIO(VGA_DAC_DATA, B_vga);
    }
}